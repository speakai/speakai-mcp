...
**117 tools, 5 resources, and 3 prompts** over one workspace of recordings, transcripts,
...
4. Run `npx @speakai/mcp-server@1.21.1 config test` to validate the key and reach the API.
