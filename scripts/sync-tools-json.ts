...
const newCategories = [
  {
    ...
    shortDescription: "Create and manage voice agents, their voice/avatar catalog, and their conversations.",
    tools: [
      "list_voice_agents",
      "get_voice_agent",
      "create_voice_agent",
  ...
  },
  {
    ...
    iconKey: "voice-agent-questions",
    shortDescription: "Attach and manage the questions a voice agent asks mid-call, and the shared question template library.",
    tools: [
  ...
  },
  {
    ...
    iconKey: "voice-agent-testing",
    shortDescription: "Define scripted test suites for a voice agent and manage test runs.",
    tools: [
